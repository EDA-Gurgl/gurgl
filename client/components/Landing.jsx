...
const Landing = () =>
   ...
   <div className="landing">
     ...
     <h2>Kids grow. Clothes do<span>n</span><span id='apostrophe'>&#39;</span>t.</h2>
      ...
      <p>
      We provide a fun, easy platform for you to recycle your childrens wardrobes, and borrow more! With your help, we <br />
      can redirect perfectly good clothing out of the landfill waste pile and onto the backs of children who need them.
      </p>
      <p>
      We can all play our part. We can have a positive impact on our planet and leave it in a better, preloved <br />
